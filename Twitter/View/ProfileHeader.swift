...
//  Twitter
//
//  Created by Bohdan Tkachenko on 1/24/23.
//
...
class ProfileHeader: UICollectionReusableView {
    ...
    private lazy var editProfileFollowButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleEditProfileFlow), for: .touchUpInside)
        return button
    }()
    ...
    private let bioLabel: UILabel = {
        ...
        label.text = "This is user biio that will span more than one line for test purposes."
        return label
    }()
